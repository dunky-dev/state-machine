...
**▶ [Watch it live](https://chimba-ui.github.io/state-machine/)** — all three engines driving a real grid in your browser. Watch which ones fall behind as the load climbs.
...
XState allocates a new immutable snapshot on every transition. Chimba UI mutates context in place — a transition allocates nothing.
...
| Irrelevant write, N observers |       Chimba UI | XState |
| ----------------------------- | --------------: | -----: |
...
| Change 1 of N observers | Chimba UI | XState |
| ----------------------- | --------: | -----: |
| 100                     |     325 K |  253 K |
| 1 000                   |    10.7 K | 10.7 K |
| 5 000                   | **7.9 K** |    741 |
...
| Context width |  Chimba UI | XState |        Zag |
| ------------- | ---------: | -----: | ---------: |
| 2 fields      |     3.6 KB | 3.6 KB |     9.1 KB |
| 64 fields     | **4.1 KB** | 4.1 KB | **134 KB** |

Going 2 → 64 fields costs Chimba UI **~0.5 KB/machine**. Zag allocates one reactive cell per field — 64-field context balloons to **134 KB/machine**, ~33× more.
...
XState cold-starts ~1.2× faster. Zag is ~3.4× slower than both. Chimba UI's bet is flat memory and hot-path throughput, not spin-up speed.
...
Full methodology, fairness notes, and all per-scenario tables in the [benchmark README](https://github.com/chimba-ui/state-machine/blob/main/benchmark/README.md).
