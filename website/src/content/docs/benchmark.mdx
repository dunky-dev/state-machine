...
|              | Dunky |   XState |  Zag |
| ------------ | ----: | -------: | ---: |
| µs / machine |  1.44 | **1.34** | 4.78 |

XState cold-starts ~1.1× faster; Zag is ~3.3× slower than both. A one-time cost paid at `start()`; see [the trade-off](#the-trade-off).
